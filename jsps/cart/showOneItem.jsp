...
<script type="text/javascript">
  ...
  <body>
<form id="form1" action="${pageContext.request.contextPath }/order/buyOneItem.action" method="post">
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
	...
	<c:forEach items="${orderToSave.items }" var="item">
		<tr align="center">
			<td align="right">
	...
	<tr>
		...
		<tr>
			<td colspan="2">
				...
				<input id="consignee" type="text" name="consigneeName" value="${sessionScope.customer.cname }"/>
			</td>
			<td colspan="4">
				<span style="font-size: 14px; font-family: 微软雅黑;">收件人电话:&nbsp;</span>
				<input id="consignee" type="text" name="consigneePhone" value="${sessionScope.customer.cphone }"/>
			</td>
		</tr>
		<tr>
			<td colspan="6">
				<span style="font-size: 14px; font-family: 微软雅黑;">收货地址:&nbsp;</span>
				<input id="addr" type="text" name="address" value="${sessionScope.customer.caddress }"/>
			</td>
		</tr>
		<tr>
			<td colspan="6">
