...
<br/><br/>
<c:choose>
	<c:when test="${empty sessionScope.cart or fn:length(sessionScope.cart.items) eq 0}">
		...
		<table width="95%" align="center" cellpadding="0" cellspacing="0">
			...
			<c:forEach items="${cart.items }" var="item">
				<tr align="center">
					...
					<td width="100px">
						<span class="price_n">&yen;<span class="subTotal" id="12345Subtotal">${item.price}</span></span>
					</td>
					<td>
